...
public class OriginCardCarouselScreen extends Screen {
    ...
    // ========== Input Handling (GLFW polling for 1.21.11) ==========
    ...
    public void tick() {
        ...
        // Poll input using GLFW (1.21.11 API change)
        ...
        if (isMousePressed && !wasMousePressed) {
            handleMouseClickInternal();
        }
        wasMousePressed = isMousePressed;
        
        // Left arrow
        boolean isLeftPressed = org.lwjgl.glfw.GLFW.glfwGetKey(windowHandle, org.lwjgl.glfw.GLFW.GLFW_KEY_LEFT) == org.lwjgl.glfw.GLFW.GLFW_PRESS;
        if (isLeftPressed && !wasLeftPressed && selectedIndex > 0) {
            selectedIndex--;
            targetScrollOffset = selectedIndex;
        }
        ...
        // Right arrow
        boolean isRightPressed = org.lwjgl.glfw.GLFW.glfwGetKey(windowHandle, org.lwjgl.glfw.GLFW.GLFW_KEY_RIGHT) == org.lwjgl.glfw.GLFW.GLFW_PRESS;
        if (isRightPressed && !wasRightPressed && selectedIndex < displayedOrigins.size() - 1) {
            selectedIndex++;
            targetScrollOffset = selectedIndex;
        }
        ...
        // Enter - confirm
        boolean isEnterPressed = org.lwjgl.glfw.GLFW.glfwGetKey(windowHandle, org.lwjgl.glfw.GLFW.GLFW_KEY_ENTER) == org.lwjgl.glfw.GLFW.GLFW_PRESS ||
                                 org.lwjgl.glfw.GLFW.glfwGetKey(windowHandle, org.lwjgl.glfw.GLFW.GLFW_KEY_KP_ENTER) == org.lwjgl.glfw.GLFW.GLFW_PRESS;
        ...
        // R - refresh
        boolean isRPressed = org.lwjgl.glfw.GLFW.glfwGetKey(windowHandle, org.lwjgl.glfw.GLFW.GLFW_KEY_R) == org.lwjgl.glfw.GLFW.GLFW_PRESS;
    ...
    private void handleMouseClickInternal() {
        // Check card clicks
