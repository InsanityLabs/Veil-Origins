...
public class NecromancerLegendary extends LegendaryAbility {
    ...
    protected void onActivate(Player player, Level level) {
        ...
        player.addEffect(new MobEffectInstance(MobEffects.STRENGTH, 400, 1, false, true));
        player.addEffect(new MobEffectInstance(MobEffects.RESISTANCE, 400, 1, false, true));
        ...
        for (int i = 0; i < 8; i++) {
            ...
            if (i % 2 == 0) {
                Zombie zombie = EntityType.ZOMBIE.create(serverLevel, null, player.blockPosition(), EntitySpawnReason.MOB_SUMMONED, false, false);
                if (zombie != null) {
                    ...
                    zombie.addEffect(new MobEffectInstance(MobEffects.STRENGTH, 600, 1));
                    zombie.addEffect(new MobEffectInstance(MobEffects.SPEED, 600, 1));
                    level.addFreshEntity(zombie);
                }
            } else {
                Skeleton skeleton = EntityType.SKELETON.create(serverLevel, null, player.blockPosition(), EntitySpawnReason.MOB_SUMMONED, false, false);
                if (skeleton != null) {
                    ...
                    skeleton.addEffect(new MobEffectInstance(MobEffects.STRENGTH, 600, 1));
