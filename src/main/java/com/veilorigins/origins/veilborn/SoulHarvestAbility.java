...
public class SoulHarvestAbility extends OriginAbility {
    ...
    public void onActivate(Player player, Level level) {
        ...
        // Find dead entities (recently killed) - we'll use living entities with low health as proxy
        ...
        if (soullessCount > 0 && soulEssenceGained == 0) {
            player.sendSystemMessage(Component.literal("§7These creatures have no souls to harvest..."));
        }
