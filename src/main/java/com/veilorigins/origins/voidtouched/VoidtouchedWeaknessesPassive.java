...
public class VoidtouchedWeaknessesPassive extends OriginPassive {
    ...
    public void onTick(Player player) {
        ...
        if (tickCounter >= 20) {
            ...
            if (random.nextDouble() < (1.0 / 60.0 / 60.0)) { // Per second chance
                ...
                player.sendSystemMessage(net.minecraft.network.chat.Component.literal("§5The void tears at your essence..."));
            }
        }
    ...
    private void randomTeleport(Player player, Level level) {
        ...
        player.sendSystemMessage(net.minecraft.network.chat.Component.literal("§5Reality shifts around you..."));
    }

    @Override
    public void onEquip(Player player) {
        player.sendSystemMessage(net.minecraft.network.chat.Component.literal("§5As Voidtouched, reality is unstable around you. You randomly teleport and cannot use beds."));
    }
